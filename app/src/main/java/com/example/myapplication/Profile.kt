...
class FragmentProfile : Fragment() {
    ...
    override fun onCreateView(
        ...
        //instance
        val textEmail:TextView = view.findViewById(R.id.editTextEmail)
        val textNama:EditText = view.findViewById(R.id.editTextUser)
        ...
        buttonSave.setOnClickListener {
            ...
            //insert data
            databaseHelper.updateAccount(email, name, password)
        }
